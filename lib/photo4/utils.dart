...
class MyMotionTabBar extends StatefulWidget {
  ...
  MyMotionTabBar({super.key,
    ...
    required this.areLabelsVisible,
    this.icons,
  ...
  @override
  _MyMotionTabBarState createState() => _MyMotionTabBarState();
}

class _MyMotionTabBarState extends State<MyMotionTabBar> with TickerProviderStateMixin {
          ...
          children: <Widget>[
            Container(
              ...
              child: Row(
                ...
                children: generateTabItems(widget.areLabelsVisible),
              ),
            ),
            IgnorePointer(
              child: Container(
  ...
  List<Widget> generateTabItems(bool areLabelsVisible) {
    ...
    return labels.map((tabLabel) {
      ...
      return MotionTabItem(
        ...
        iconData: icon,
        title: areLabelsVisible ? tabLabel : "",
